...
void simulate()
{
	...
	vec_intializer(position_1,400.0,250.0);
	vec_intializer(position_2,500.0,250.0);
	vec_intializer(position_3,650.0,250.0);
	vec_intializer(position_4,200.0,250.0);

	double velocity_1[2],velocity_2[2],velocity_3[2],velocity_4[2];
	vec_intializer(velocity_1,0,-5);
	vec_intializer(velocity_2,0,5);
	vec_intializer(velocity_3,0,-500);
	vec_intializer(velocity_4,0,500);
